...
class ProductController {
    novoProduto(cod_barra, nome, id_pos, largura, altura, peso, comprimento, id_emb, bloqueio, qtd) {

        database.insert({ cod_barra, nome, id_pos, largura, altura, peso, comprimento, id_emb, bloqueio, qtd }).table("produto").then(data => {
    ...
    atualizarProduto(req, res) {
        ...
        database.where({ cod_barra: id }).update({ nome: nome, id_pos: posicao, largura: largura, altura: altura, peso: peso, comprimento: comprimento, id_emb: embalagem, bloqueio: bloqueio, qtd: qtd }).table('produto').then(data => {
